...
class Q2S1Q11
{
    ...
    public function __construct ($id,$databaseIdQuestion,$classReadingTheme,$testeeTotalNumber,$testeeTotalCorrectAnswer,$samePassage,$text,$question,$choiceA,
    ...
    public function getText()
    {
        ...
        $str1 = str_replace("【", " <u> ", $questionText);
    ...
    {
        $str1 = str_replace("【", " <u> ", trim($this->question));
        $str2 = str_replace("】", " </u> ", $str1);
        return $str2;
    }
