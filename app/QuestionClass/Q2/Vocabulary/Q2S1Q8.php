...
class Q2S1Q8
{
    ...
    {
        $str = $this->question;       
        $str1 = str_replace("【　 】", "_____", $str);
        $str2 = str_replace("【 ★  】", "__★__", $str1);
        //bazida ma'lumot yuqoridagi "__★__" holatda kelib qolishi mumkin.
        //Shunday holatda yuqoridagi kodni o'chirish kifoya
        

        $questionText = trim($str2);  
        $detectText = "_";
        $lastPos = 0;
        $positions = array();
