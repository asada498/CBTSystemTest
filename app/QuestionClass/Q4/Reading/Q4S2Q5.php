...
class Q4S2Q5
{
    ...
    public function __construct ($id,$databaseIdQuestion,$classReadingTheme,$classReading,$testeeTotalNumber,$testeeTotalCorrectAnswer,$samePassage,$text,$question,$choiceA,
