...
namespace App\QuestionClass\Q5\Listening;
...
class Q5S3Q2
{
    ...
    public function __construct ($id, $qid, $group1, $group2, $group3, $pastTesteeNumber, $correctTesteeNumber, $question,
                                    $pattern, $choiceA, $choiceB, $choiceC, $choiceD, $illustration,
