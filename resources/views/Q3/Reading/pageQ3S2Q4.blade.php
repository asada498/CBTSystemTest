...
<html>
 ...
 <body>
  <div class="box">
   <div id="table_data">
    @include('Q3\Reading\paginationDataQ3S2Q4')
   </div>
   <script>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
    url:"{{ url('/Q3ReadingQ4/fetchData?page=') }}"+page,
//   url:"/nat-test/Q3ReadingQ4/fetchData?page="+page,
//   url:"/Q3ReadingQ4/fetchData?page="+page,
   success:function(data)
   {
     //alert('suces');
