...
<html>
 ...
 <body>
  <div class="box">
   <div id="table_data">
    @include('Q3\Reading\paginationDataQ3S2Q1')
   </div>
   <script>
...
@endif
localStorage.setItem("timeCountDownQ3S2", countDownDate);
...
$(document).ready(function(){
 ...
 {
  $.ajax({
    url:"{{ url('/Q3ReadingQ1/fetchData?page=') }}"+page,
//url:"/Q3ReadingQ1/fetchData?page="+page,
//url:"/nat-test/Q3ReadingQ1/fetchData?page="+page,
   success:function(data)
   {
