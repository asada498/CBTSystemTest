  ...
  <div class="container boxForOpening">
   <br />
    ...
    <div align="center" class="background-welcome-page">
     <label><h1 style="font-size:50px"><strong>３<ruby>級<rt>きゅう<rt></ruby>の　テストは 　<ruby>終<rt>お</rt></ruby>わりました。</strong></h1></label><br />
     ...
     <button class = "buttonLogin" type="button" onclick="window.location='{{ url('/Q3TestResult')}}'">ログイン　がめんへ</button>
    </div>
   <br />
  </div>
