...
<html>
 ...
 <body>
  <div class="box">
   <div id="table_data">
    @include('Q3\Vocabulary\paginationDataQ3S1Q2')
   </div>
   <script>   
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"{{ url('/Q3VocabularyQ2/fetchData?page=') }}"+page,
//url:"/nat-test/Q3VocabularyQ2/fetchData?page="+page,
//url:"/Q3VocabularyQ2/fetchData?page="+page,
   success:function(data)
   {
