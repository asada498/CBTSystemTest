...
<html>
 ...
 <body>
  <div class="box">
   <div id="table_data">
    @include('Q3\Vocabulary\paginationDataQ3S1Q4')
   </div>
   <script>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"{{ url('/Q3VocabularyQ4/fetchData?page=') }}"+page,
//url:"/nat-test/Q3VocabularyQ4/fetchData?page="+page,
//url:"/Q3VocabularyQ4/fetchData?page="+page,
   success:function(data)
   {
