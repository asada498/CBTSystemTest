...
<html>
 ...
 <body>
  <div class="box">
   <div id="table_data">
    @include('Q5\Vocabulary\paginationDataQ5S1Q1')
   </div>
   <script>
// Set the date we're counting down to
  ...
  @endif
localStorage.setItem('timeCountDownQ5S1', countDownDate);
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"/nat-test/Q5VocabularyQ1/fetchData?page="+page,
   success:function(data)
   {
