...
<html>
 ...
 <body>
  ...
  <div class="container">
   ...
   <h3 align="center">にほんご　NAT-TEST　へ　ようこそ</h3>
   <h3 align="center">Welcome to Japanese NAT-TEST</h3><br />
    </div>
   ...
   <form method="post" action="{{ url('/main/checklogin') }}">
    ...
    <div class="form-group">
        <div class = "left-side-login">
            <label class = "normal-label">じゅけんばんごうを　いれてください<br />Put your examinee number.</label>
        </div>
    ...
    <div class="form-group login-button">
     <input type="submit" name="login" class="btn btn-primary" value="Start" />
    </div>
   </form>
  </div>
 </body>
