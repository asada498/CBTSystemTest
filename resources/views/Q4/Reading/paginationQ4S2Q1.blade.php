...
<html>
 ...
 <body>
  <div class="box">
   <div id="table_data">
    @include('Q4\Reading\paginationDataQ4S2Q1')
   </div>
   <script>
...
@endif
localStorage.setItem('timeCountDownQ4S2', countDownDate);
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"/nat-test/Q4ReadingQ1/fetchData?page="+page,
   success:function(data)
   {
