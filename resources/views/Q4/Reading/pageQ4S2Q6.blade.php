        ...
        function myFunction(id) {
            $.ajax({
              headers: {
                ...
                type:'POST',
                url:'/nat-test/saveChoiceRequestQ4S2Q6',
 ...
 <div  class = "time-border">  <h4>あと<label class = "time-style" id="japaneseSentence">　</label>ふん</h4></div>
  <div class="question-title-width">
    <div class="left-side-problem-number" >
        <div class = "title1">  <h1>問題６</h1></div>
    </div>
  ...
  <div class = "Q5S2Q6-style">
    <div class = "Q5S2Q6-left-side">
      ...
      <div class = "title1">          <img src="{{url('/image/4Q/reading/Q4S2Q6/'.$image)}}" style="max-width:900px"alt="Image"/></div>
      @endforeach
    </div>
  ...
  <form method="post" action="{{ url('/Q4ReadingQ6SubmitData')}}" id="yourForm" name="yourForm">
  {{ csrf_field() }}
