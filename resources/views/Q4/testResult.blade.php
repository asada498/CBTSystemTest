...
<html>
 ...
 <a id = "triangle-arrow-down" class = "triangle-arrow-down" onclick = " scrollDown(this)"></a>
   ...
   <div class = "user-information">
        <div class = "title-middle big-title"><ruby><rb>日</rb><rt>に</rt><rb>本</rb><rt>ほん</rt><rb>語</rb><rt>ご</rt>　</ruby>NATーTEST　4<ruby><rb>級</rb><rt>きゅう</rt></ruby></div>
        ...
        <div class = "table-diff">
          <table id = "questionSummaryTable" class = "same-line-chart question1">
            <tr>
              <th rowspan = "6" class = "title-middle"><ruby><rb>第</rb><rt>だい</rt><rb>一</rb><rt>いち</rt><rb>部</rb><rt>ぶ</rt><rb>門</rb><rt>もん</rt></ruby></th>
            ...
            <tr>
              <td class = "title-middle"><ruby><rb>用</rb><rt>よう</rt></ruby><ruby><rb>法</rb><rt>ほう</rt></ruby></td>
              <td class = "score-column-style">{{ $query->s1_q5_rate}} %</td>
            </tr>
          </table>
        ...
        <div class = "table-diff">
          <table id = "questionSummaryTable" class = "same-line-chart question1">
            <tr>
              <th rowspan = "6" class = "title-middle"><ruby><rb>第</rb><rt>だい</rt><rb>三</rb><rt>さん</rt><rb>部</rb><rt>ぶ</rt><rb>門</rb><rt>もん</rt></ruby></th>
              <th class = "title-middle">もんだい</th>
              <th class = "title-middle">あなたの<ruby><rb>正</rb><rt>せい</rt><rb>答</rb><rt>とう</rt><rb>率</rb><rt>りつ</rt></ruby></th>
            </tr>
            <tr>
        ...
        <script type="text/javascript">
                ...
                datasets: [　 
                    {　
                        ...
                        data: [{{ $query->s1_q1_rate}},{{ $query->s1_q2_rate}}, {{ $query->s1_q3_rate}}, {{ $query->s1_q4_rate}},{{ $query->s1_q5_rate}}]　
                    }
                ]
            };
