  ...
  <div class="box">
   <br />
    ...
    <div align="center">
     ...
     <label><h2 style="font-size:30px"><strong>しけんじかんは　５５　ふん　です。</strong></h2></label><br />
     <button class = "buttonLogin" type="button" onclick="window.location='{{ url('/Q4ReadingQ1')}}'" class="middle-screen">はじめる</button>
    </div>
