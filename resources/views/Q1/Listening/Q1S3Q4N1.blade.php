@inject('Q1S3Q4', 'App\Http\Controllers\Q1\Listening\Q1S3Q4N1Controller')

<!DOCTYPE html>
<html>
  <head>
    <title>Q1ListeningQ4</title>
    ...
    <script>
      function init()
      {
        ...
        audio5.addEventListener("ended", function() { window.location.href = "{{ url('/Q1ListeningQ4N2') }}"; });
      ...
      function myFunction(id) {
        $.ajax({
          ...
          type:'POST',
          url:"{{ url('/saveChoiceRequestQ1S3Q4N1') }}",
  ...
  <body onload="init();">
    ...
    <div class = "title1">
      <img src="{{ asset('image/1Q/example/q1s3q4example.png') }}" alt="Image"/>
    </div>
    <div class="box">
      <div id="table_data">
          ...
          <div class="container box">
            <div class="test">
                  ...
                  <p><span class="sec3-ban">１<ruby><rb>番</rb><rt>ばん</rt></ruby></span>
                      @if(!(app()->isProduction()))
        　　　        <button type="button" onclick="window.location='{{ url('/Q1ListeningQ4N2') }}'" style="vertical-align: right;">skip</button>
                      @endif
                  ...
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[0]->getNo()}}" id="{{$data[0]->getNo()}}a" value="a" {{ $Q1S3Q4->checkValue($data[0]->getNo(),"a") }} onclick=" myFunction(this)" /><label for="{{$data[0]->getNo()}}a"> &nbsp; a.&nbsp;</label></span> 
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[0]->getNo()}}" id="{{$data[0]->getNo()}}b" value="b" {{ $Q1S3Q4->checkValue($data[0]->getNo(),"b") }} onclick=" myFunction(this)" /><label for="{{$data[0]->getNo()}}b"> &nbsp; b.&nbsp;</label></span>
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[0]->getNo()}}" id="{{$data[0]->getNo()}}c" value="c" {{ $Q1S3Q4->checkValue($data[0]->getNo(),"c") }} onclick=" myFunction(this)" /><label for="{{$data[0]->getNo()}}c"> &nbsp; c.&nbsp;</label></span>
                <br><br>
                  ...
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[1]->getNo()}}" id="{{$data[1]->getNo()}}a" value="a" {{ $Q1S3Q4->checkValue($data[1]->getNo(),"a") }} onclick=" myFunction(this)" /><label for="{{$data[1]->getNo()}}a"> &nbsp; a.&nbsp;</label></span> 
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[1]->getNo()}}" id="{{$data[1]->getNo()}}b" value="b" {{ $Q1S3Q4->checkValue($data[1]->getNo(),"b") }} onclick=" myFunction(this)" /><label for="{{$data[1]->getNo()}}b"> &nbsp; b.&nbsp;</label></span>
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[1]->getNo()}}" id="{{$data[1]->getNo()}}c" value="c" {{ $Q1S3Q4->checkValue($data[1]->getNo(),"c") }} onclick=" myFunction(this)" /><label for="{{$data[1]->getNo()}}c"> &nbsp; c.&nbsp;</label></span>
                <br><br>
                  ...
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[2]->getNo()}}" id="{{$data[2]->getNo()}}a" value="a" {{ $Q1S3Q4->checkValue($data[2]->getNo(),"a") }} onclick=" myFunction(this)" /><label for="{{$data[2]->getNo()}}a"> &nbsp; a.&nbsp;</label></span> 
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[2]->getNo()}}" id="{{$data[2]->getNo()}}b" value="b" {{ $Q1S3Q4->checkValue($data[2]->getNo(),"b") }} onclick=" myFunction(this)" /><label for="{{$data[2]->getNo()}}b"> &nbsp; b.&nbsp;</label></span>
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[2]->getNo()}}" id="{{$data[2]->getNo()}}c" value="c" {{ $Q1S3Q4->checkValue($data[2]->getNo(),"c") }} onclick=" myFunction(this)" /><label for="{{$data[2]->getNo()}}c"> &nbsp; c.&nbsp;</label></span>
                <br><br>
                  ...
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[3]->getNo()}}" id="{{$data[3]->getNo()}}a" value="a" {{ $Q1S3Q4->checkValue($data[3]->getNo(),"a") }} onclick=" myFunction(this)" /><label for="{{$data[3]->getNo()}}a"> &nbsp; a.&nbsp;</label></span> 
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[3]->getNo()}}" id="{{$data[3]->getNo()}}b" value="b" {{ $Q1S3Q4->checkValue($data[3]->getNo(),"b") }} onclick=" myFunction(this)" /><label for="{{$data[3]->getNo()}}b"> &nbsp; b.&nbsp;</label></span>
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[3]->getNo()}}" id="{{$data[3]->getNo()}}c" value="c" {{ $Q1S3Q4->checkValue($data[3]->getNo(),"c") }} onclick=" myFunction(this)" /><label for="{{$data[3]->getNo()}}c"> &nbsp; c.&nbsp;</label></span>
                <br><br>
                  ...
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[4]->getNo()}}" id="{{$data[4]->getNo()}}a" value="a" {{ $Q1S3Q4->checkValue($data[4]->getNo(),"a") }} onclick=" myFunction(this)" /><label for="{{$data[4]->getNo()}}a"> &nbsp; a.&nbsp;</label></span> 
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[4]->getNo()}}" id="{{$data[4]->getNo()}}b" value="b" {{ $Q1S3Q4->checkValue($data[4]->getNo(),"b") }} onclick=" myFunction(this)" /><label for="{{$data[4]->getNo()}}b"> &nbsp; b.&nbsp;</label></span>
                  <span class="sec3-q4-c1-tight"><input type="radio" name="{{$data[4]->getNo()}}" id="{{$data[4]->getNo()}}c" value="c" {{ $Q1S3Q4->checkValue($data[4]->getNo(),"c") }} onclick=" myFunction(this)" /><label for="{{$data[4]->getNo()}}c"> &nbsp; c.&nbsp;</label></span>
            </div>
          </div>
        </form> 
      </div>
