...
<html>
 ...
 <body>
  <div class="box">
   <div id="table_data">
    @include('Q1\Vocabulary\paginationDataQ1S1Q1')
   </div>
   <script>
...
@endif
localStorage.setItem("timeCountDownQ1S1", countDownDate);
...
$(document).ready(function(){
 ...
 {
  $.ajax({
    url:"{{ url('/Q1VocabularyQ1/fetchData?page=') }}"+page, 
   success:function(data)
   {
